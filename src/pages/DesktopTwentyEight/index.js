        ...
        <Column className="items-center w-[100%]">
          <header className="w-[100%]">
            <Row className="bg-white_A700 items-center lg:p-[10px] xl:p-[12px] 2xl:p-[14px] 3xl:p-[16px] shadow-bs5 w-[100%]">
              ...
              <Text className="hover:bg-gray_500 cursor-pointer hover:font-normal font-normal font-tirobangla italic hover:justify-center lg:ml-[13px] xl:ml-[15px] 2xl:ml-[17px] 3xl:ml-[20px] lg:text-[18px] xl:text-[21px] 2xl:text-[24px] 3xl:text-[28px] text-gray_500 w-[auto]">
                Confirm
              </Text>
            </Row>
          </header>
        </Column>
        <Column className="items-end lg:mt-[32px] xl:mt-[37px] 2xl:mt-[42px] 3xl:mt-[50px] lg:px-[38px] xl:px-[43px] 2xl:px-[49px] 3xl:px-[58px] w-[100%]">
          <Column className="items-center w-[95%]">
            ...
            <Row className="items-center justify-evenly lg:mt-[56px] xl:mt-[64px] 2xl:mt-[73px] 3xl:mt-[87px] w-[100%]">
              <Column className="w-[70%]">
                ...
                <footer className="bg-white_A700 font-tirobangla lg:mt-[39px] xl:mt-[45px] 2xl:mt-[51px] 3xl:mt-[61px] rounded-radius15 shadow-bs1 w-[89%]">
                  <Row className="items-center justify-between lg:ml-[18px] xl:ml-[21px] 2xl:ml-[24px] 3xl:ml-[28px] lg:mr-[31px] xl:mr-[36px] 2xl:mr-[41px] 3xl:mr-[49px] lg:my-[35px] xl:my-[40px] 2xl:my-[46px] 3xl:my-[55px] w-[92%]">
                ...
                <Button className="font-baloo1 font-normal lg:ml-[320px] xl:ml-[366px] 2xl:ml-[412px] 3xl:ml-[494px] lg:mt-[39px] xl:mt-[45px] 2xl:mt-[51px] 3xl:mt-[61px] not-italic lg:text-[23px] xl:text-[26px] 2xl:text-[30px] 3xl:text-[36px] text-center w-[42%]">
                  Pay now
                </Button>
              </Column>
              <Column className="bg-white_A700 items-center 2xl:p-[11px] 3xl:p-[13px] lg:p-[8px] xl:p-[9px] rounded-radius15 shadow-bs1 w-[30%]">
                <Column className="lg:mt-[10px] xl:mt-[11px] 2xl:mt-[13px] 3xl:mt-[15px] w-[98%]">
                  ...
                  <Text className="font-normal 3xl:ml-[10px] lg:ml-[7px] xl:ml-[8px] 2xl:ml-[9px] lg:mt-[13px] xl:mt-[15px] 2xl:mt-[17px] 3xl:mt-[20px] not-italic lg:text-[18px] xl:text-[21px] 2xl:text-[24px] 3xl:text-[28px] text-deep_orange_500 w-[auto]">
                    Tour ID: 0123456789
                  </Text>
                  <Img
                    src="images/img_rectangle57.png"
                    className="lg:h-[152px] xl:h-[174px] 2xl:h-[196px] 3xl:h-[235px] lg:mt-[12px] xl:mt-[14px] 2xl:mt-[16px] 3xl:mt-[19px] rounded-radius32 w-[97%]"
                  ...
                  <Line className="bg-deep_orange_500 h-[2px] lg:mt-[23px] xl:mt-[26px] 2xl:mt-[30px] 3xl:mt-[36px] w-[99%]" />
