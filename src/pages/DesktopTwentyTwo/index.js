...
const DesktopTwentyTwoPage = () => {
  return (
    <>
      <Column className="bg-yellow_50 font-tirobangla items-end mx-[auto] 3xl:pb-[110px] lg:pb-[71px] xl:pb-[81px] 2xl:pb-[92px] w-[100%]">
        ...
        <Column className="lg:mt-[32px] xl:mt-[37px] 2xl:mt-[42px] 3xl:mt-[50px] w-[92%]">
          ...
          <Row className="justify-evenly lg:mt-[56px] xl:mt-[64px] 2xl:mt-[73px] 3xl:mt-[87px] w-[100%]">
            ...
            <Stack className="lg:h-[644px] xl:h-[737px] 2xl:h-[829px] 3xl:h-[995px] mt-[1px] lg:pr-[39px] xl:pr-[45px] 2xl:pr-[51px] 3xl:pr-[61px] w-[33%]">
              <Stack className="absolute lg:h-[644px] xl:h-[737px] 2xl:h-[829px] 3xl:h-[995px] left-[0] w-[88%]">
                <div className="absolute bg-white_A700 lg:h-[644px] xl:h-[737px] 2xl:h-[829px] 3xl:h-[995px] rounded-radius15 shadow-bs1 w-[100%]"></div>
                <Column className="absolute inset-x-[0] mx-[auto] top-[4%] w-[93%]">
                  ...
                  <Line className="bg-deep_orange_500 h-[2px] 3xl:mr-[10px] lg:mr-[7px] xl:mr-[8px] 2xl:mr-[9px] xl:mt-[10px] 2xl:mt-[12px] 3xl:mt-[14px] lg:mt-[9px] w-[97%]" />
                  <Line className="bg-deep_orange_500 h-[2px] 3xl:mr-[10px] lg:mr-[7px] xl:mr-[8px] 2xl:mr-[9px] lg:mt-[53px] xl:mt-[61px] 2xl:mt-[69px] 3xl:mt-[82px] w-[97%]" />
                  <Img
                    src="images/img_rectangle34.png"
                    className="3xl:h-[116px] lg:h-[75px] xl:h-[86px] 2xl:h-[97px] lg:ml-[63px] xl:ml-[72px] 2xl:ml-[81px] 3xl:ml-[97px] lg:mt-[37px] xl:mt-[42px] 2xl:mt-[48px] 3xl:mt-[57px] w-[51%]"
                    alt="RectangleThirtyFour"
                  />
                  <Row className="justify-between lg:ml-[10px] xl:ml-[11px] 2xl:ml-[13px] 3xl:ml-[15px] mt-[3px] w-[96%]">
                  ...
                  <Line className="bg-deep_orange_500 h-[2px] 3xl:ml-[10px] lg:ml-[7px] xl:ml-[8px] 2xl:ml-[9px] mr-[1px] lg:mt-[19px] xl:mt-[22px] 2xl:mt-[25px] 3xl:mt-[30px] w-[97%]" />
                  <Line className="bg-deep_orange_500 h-[2px] 3xl:ml-[10px] lg:ml-[7px] xl:ml-[8px] 2xl:ml-[9px] mr-[1px] lg:mt-[119px] xl:mt-[136px] 2xl:mt-[154px] 3xl:mt-[184px] w-[97%]" />
                  <Line className="bg-deep_orange_500 h-[2px] 3xl:ml-[10px] lg:ml-[7px] xl:ml-[8px] 2xl:ml-[9px] mr-[1px] lg:mt-[144px] xl:mt-[165px] 2xl:mt-[186px] 3xl:mt-[223px] w-[97%]" />
                </Column>
              </Stack>
              <Column className="absolute bottom-[6%] left-[7%] w-[80%]">
                <Text className="font-normal ml-[3px] not-italic lg:text-[18px] xl:text-[21px] 2xl:text-[24px] 3xl:text-[28px] text-deep_orange_500 w-[auto]">
                  Booking ID: 123456789
                </Text>
                <Text className="font-normal lg:mt-[44px] xl:mt-[50px] 2xl:mt-[57px] 3xl:mt-[68px] not-italic lg:text-[18px] xl:text-[21px] 2xl:text-[24px] 3xl:text-[28px] text-deep_orange_500 w-[auto]">
                  Departure • Tue, 20 Sep 2022
                </Text>
                <Text className="font-normal ml-[3px] lg:mt-[161px] xl:mt-[184px] 2xl:mt-[207px] 3xl:mt-[248px] not-italic lg:text-[18px] xl:text-[21px] 2xl:text-[24px] 3xl:text-[28px] text-deep_orange_500 w-[auto]">
                  Nguyen Van A
                </Text>
                <Text className="font-normal ml-[3px] lg:mt-[13px] xl:mt-[15px] 2xl:mt-[17px] 3xl:mt-[20px] not-italic lg:text-[18px] xl:text-[21px] 2xl:text-[24px] 3xl:text-[28px] text-deep_orange_500 w-[auto]">
                  0123456789
                </Text>
                <Text className="font-normal ml-[3px] lg:mt-[12px] xl:mt-[14px] 2xl:mt-[16px] 3xl:mt-[19px] not-italic lg:text-[18px] xl:text-[21px] 2xl:text-[24px] 3xl:text-[28px] text-deep_orange_500 w-[auto]">
                  nguyenvana@gmail.com
                </Text>
                <Text className="font-normal lg:ml-[5px] xl:ml-[6px] 2xl:ml-[7px] 3xl:ml-[8px] lg:mt-[28px] xl:mt-[32px] 2xl:mt-[37px] 3xl:mt-[44px] not-italic lg:text-[21px] xl:text-[24px] 2xl:text-[28px] 3xl:text-[33px] text-gray_500 w-[auto]">
                  1 Adult
                </Text>
                <Text className="font-normal lg:ml-[5px] xl:ml-[6px] 2xl:ml-[7px] 3xl:ml-[8px] lg:mt-[15px] xl:mt-[17px] 2xl:mt-[20px] 3xl:mt-[24px] not-italic lg:text-[21px] xl:text-[24px] 2xl:text-[28px] 3xl:text-[33px] text-gray_500 w-[auto]">
                  Economy
                </Text>
                <Text className="font-normal lg:ml-[5px] xl:ml-[6px] 2xl:ml-[7px] 3xl:ml-[8px] lg:mt-[14px] xl:mt-[16px] 2xl:mt-[19px] 3xl:mt-[22px] not-italic lg:text-[18px] xl:text-[21px] 2xl:text-[24px] 3xl:text-[28px] text-deep_orange_500 w-[auto]">
                  Nguyen Van A
                </Text>
                <Text className="font-normal 2xl:ml-[10px] 3xl:ml-[12px] lg:ml-[7px] xl:ml-[8px] 2xl:mt-[10px] 3xl:mt-[12px] lg:mt-[7px] xl:mt-[8px] not-italic lg:text-[18px] xl:text-[21px] 2xl:text-[24px] 3xl:text-[28px] text-deep_orange_500 w-[auto]">
                  0123456789
                </Text>
                <Row className="justify-between lg:ml-[5px] xl:ml-[6px] 2xl:ml-[7px] 3xl:ml-[8px] lg:mt-[36px] xl:mt-[41px] 2xl:mt-[47px] 3xl:mt-[56px] w-[98%]">
                  <Text className="font-normal not-italic lg:text-[21px] xl:text-[24px] 2xl:text-[28px] 3xl:text-[33px] text-gray_500 w-[auto]">
                    Package
                  </Text>
